...
$query = $conn->query("SELECT datetime,name,value FROM log   WHERE name like '%Port 6 %' ");
//$row = "this is a test"
// Fetch the first row
...
$array1= array( 'Port 6 Frequency' , 'Port 6 Voltage Average' , 'Port 6 Voltage Line Average' , 'Port 6 Current Average' , 'Port 6 Power Total' , 'Port 6 Reactive Power Total' , 'Port 6 Apparent Power Total' , 'Port 6 Power Facto Total' , 'Port 6 Energy Total' , 'Port 6 Energy Net');
