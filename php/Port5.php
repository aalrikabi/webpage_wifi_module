...
$query = $conn->query("SELECT datetime,name,value FROM log   WHERE name like '%Port 5 %' ");
//$row = "this is a test"
// Fetch the first row
...
$array1= array( 'Port 5 Frequency' , 'Port 5 Voltage Average' , 'Port 5 Voltage Line Average' , 'Port 5 Current Average' , 'Port 5 Power Total' , 'Port 5 Reactive Power Total' , 'Port 5 Apparent Power Total' , 'Port 5 Power Facto Total' , 'Port 5 Energy Total' , 'Port 5 Energy Net');
