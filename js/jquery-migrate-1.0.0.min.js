...
void 0 && (jQuery.migrateMute = !0), function(e, t, n) {
	...
	var i = {},
	    u = e.attr,
	    s = e.attrHooks.value && e.attrHooks.value.get ||
	function() {
		return null
	},
	...
	a(e, "attrFn", i, "jQuery.attrFn is deprecated"), e.attr = function(t, a, o, i) {
		...
		set : function(e, t) {
			...
			return "button" === a ? c.apply(this, arguments) : ("input" !== a && "option" !== a && r("property-based jQuery.fn.attr('value', val) is deprecated"), e.value =
			t, n)
		}
	};
	var g,
	...
	h = {}, g.browser && (h[g.browser] = !0, h.version = g.version), h.chrome ? h.webkit = !0 : h.webkit && (h.safari = !0), e.browser =
	h, a(e, "browser", h, "jQuery.browser is deprecated"), e.sub = function() {
		function t(e, n) {
			return new t.fn.init(e, n)
		}
		e.extend(!0, t, this), t.superclass = this, t.fn = t.prototype = this(), t.fn.constructor =
		t, t.sub = this.sub, t.fn.init = function(r, a) {
	...
	e.fn.data = function(t) {
		...
		o = e._data(i, t), a !== n && a !== o || o === n) ? y.apply(this, arguments) : (r("Use of jQuery.fn.data('events') is deprecated"), o)
	};
	...
	e.fn.andSelf = function() {
		...
		a = a || document,
		a = !a.nodeType && a[0] || a,
		a = a.ownerDocument || a, r("jQuery.clean() is deprecated");
		var u,
		    s,
		    c,
		    d,
