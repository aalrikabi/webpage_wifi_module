...
$query = $conn->query("SELECT datetime,name,value FROM log   WHERE name like '%Port 7 %' ");
//$row = "this is a test"
// Fetch the first row
...
$array1= array( 'Port 7 Frequency' , 'Port 7 Voltage Average' , 'Port 7 Voltage Line Average' , 'Port 7 Current Average' , 'Port 7 Power Total' , 'Port 7 Reactive Power Total' , 'Port 7 Apparent Power Total' , 'Port 7 Power Facto Total' , 'Port 7 Energy Total' , 'Port 7 Energy Net');
