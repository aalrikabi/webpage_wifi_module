...
$query = $conn->query("SELECT datetime,name,value FROM log   WHERE name like '%Port 8 %' ");
//$row = "this is a test"
// Fetch the first row
...
$array1= array( 'Port 8 Frequency' , 'Port 8 Voltage Average' , 'Port 8 Voltage Line Average' , 'Port 8 Current Average' , 'Port 8 Power Total' , 'Port 8 Reactive Power Total' , 'Port 8 Apparent Power Total' , 'Port 8 Power Facto Total' , 'Port 8 Energy Total' , 'Port 8 Energy Net');
