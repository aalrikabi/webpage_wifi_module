...
$query = $conn->query("SELECT datetime,name,value FROM log   WHERE name like '%Port 3 %' ");
//$row = "this is a test"
// Fetch the first row
...
$array1= array( 'Port 3 Frequency' , 'Port 3 Voltage Average' , 'Port 3 Voltage Line Average' , 'Port 3 Current Average' , 'Port 3 Power Total' , 'Port 3 Reactive Power Total' , 'Port 3 Apparent Power Total' , 'Port 3 Power Facto Total' , 'Port 3 Energy Total' , 'Port 3 Energy Net');
