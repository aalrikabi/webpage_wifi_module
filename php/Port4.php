...
$query = $conn->query("SELECT datetime,name,value FROM log   WHERE name like '%Port 4 %' ");
//$row = "this is a test"
// Fetch the first row
...
$array1= array( 'Port 4 Frequency' , 'Port 4 Voltage Average' , 'Port 4 Voltage Line Average' , 'Port 4 Current Average' , 'Port 4 Power Total' , 'Port 4 Reactive Power Total' , 'Port 4 Apparent Power Total' , 'Port 4 Power Facto Total' , 'Port 4 Energy Total' , 'Port 4 Energy Net');
