...
$query = $conn->query("SELECT datetime,name,value FROM log   WHERE name like '%Port 9 %' ");
//$row = "this is a test"
// Fetch the first row
...
$array1= array( 'Port 9 Frequency' , 'Port 9 Voltage Average' , 'Port 9 Voltage Line Average' , 'Port 9 Current Average' , 'Port 9 Power Total' , 'Port 9 Reactive Power Total' , 'Port 9 Apparent Power Total' , 'Port 9 Power Facto Total' , 'Port 9 Energy Total' , 'Port 9 Energy Net');
