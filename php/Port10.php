...
$query = $conn->query("SELECT datetime,name,value FROM log   WHERE name like '%Port 10 %' ");
//$row = "this is a test"
// Fetch the first row
...
$array1= array( 'Port 10 Frequency' , 'Port 10 Voltage Average' ,
    'Port 10 Voltage Line Average' , 'Port 10 Current Average' ,
    'Port 10 Power Total' , 'Port 10 Reactive Power Total' ,
    'Port 10 Apparent Power Total' , 'Port 10 Power Facto Total' ,
    'Port 10 Energy Total' , 'Port 10 Energy Net');
